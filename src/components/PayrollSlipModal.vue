                        ...
                        <div class="content">
                            ...
                            <div class="btn-wrap" >
                                <table class="table">
                                    <tbody>
                                    <tr>
                                        <th style="width: 140px;">공급처명</th>
                                        <td colspan="5">{{slipDetail.vendorNm}}</td>
                                        <th style="width: 140px;" >지급방법</th>
                                        <td colspan="2">{{slipDetail.payMthdLookupCd}}</td>
                                        <th style="width: 140px;">지급조건</th>
                                        <td colspan="2">{{slipDetail.payTerm}}</td>
                                    </tr>
                                    <tr>
                                        <th style="width: 140px;">지점명</th>
                ...
                */
                ...
                this.$modal.open({
                    ...
                    props: {
                        ...
                        readonly: readonly, //this.isReadonly // Check readonly
