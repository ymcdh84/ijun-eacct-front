  ...
  <div slot="content">
    <div class="scan-area">
      ...
      <div class="scan-item02">
        ...
        <div class="scan-desc" @dragover.prevent @dragenter.prevent @drop.prevent="dragoverInput">
          <ul>
...
export default {
  ...
  methods: {
    ...
    storeFileCnt(){
      localStorage.setItem("popFileCnt", this.a_files.length);
    },
    dragoverInput(event){
  ...
  created() {
    ...
    this.docMngNo = this.$route.query.docMngNo

    var rdoVal = this.$route.query.readonly
    this.readonly = (rdoVal === 'true')

    var rdoCtrlVal = this.$route.query.readonlyCtrl
    this.readonlyCtrl = (rdoCtrlVal === 'true')
