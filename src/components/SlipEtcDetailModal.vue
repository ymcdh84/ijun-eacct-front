    ...
    <div>
     ...
     <div class="content-name">
         <div class="table-name">
            <h3 class="ico_table_name" style="float:left">기타전표 정보</h3>
        </div>
      </div>
      <div class="table-area">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 140px;">지급예정일</th>
                                    <td class="rightDt" colsapn="3">{{erpSlipHeader.payDueDt === null ? '' : $moment(erpSlipHeader.payDueDt).format('YYYY-MM-DD')}}</td>
                                </tr>
                                <tr>
        ...
        <div class="table-b">
            <div class="content-name">
                <div class="table-name">
                    <h3 class="ico_table_name">기타전표 정보</h3>
                </div>
            </div>
            <div class="grid-wrap">
...
export default {
    ...
    return {
      config:{
          columns: [
            ...
            {id: 'acctCd', type: 'ro', align: 'center', sort: 'na', value: '#cspan', width: 60},
  ...
  methods: {
        ...
        this.$http.get(`api/erp/slip/detail/${this.grSlipNo}`
            ...
            if (response.data) {
                try{
                    ...
                    this.url = 'http://197.200.29.30:30000/dti/api/v1/view/'+ this.etaxXmlHd.etaxNO + '?stype=AP';
    ...
    openUploadEvidencePopup() {
        ...
        //예외1 (조회권한이 전체인 사용자는 검인2 전까지 첨부가 가능)
        ...
        */
        ...
        if ((navigator.appName == 'Netscape' && navigator.userAgent.search('Trident') != -1) || (agent.indexOf("msie") != -1)){
          this.objectPopup.attachEvent("onunload",function(){
            vm.etaxXmlHd.ufileCnt = localStorage.getItem("popFileCnt");
            vm.$forceUpdate();
        ...
        //         readonly: readonly,
        //         readonlyCtrl: rdoCtrl//this.isReadonly // Check readonly
        //     },
        //     parent: this,
        //     width: 1200,
        //     events: {
        //         close(value) {
        //             etaxXmlHd.ufileCnt = value.length
        //         }
        //     }
        // })
    },
