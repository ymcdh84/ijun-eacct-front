...
export default {
    ...
    return {
      ...
      grid: {
        head: [
          ...
          {id: 'bankAcctNm', type: 'ro', align: 'left', sort: 'str', value: '계좌명'},
          {id: 'bankBranchNm', type: 'ro', align: 'center', sort: 'str', value: '지점'},
        ],
        data: [],
      },
      returnObject: {}
  ...
  methods: {
    ...
    doReturnObject(rId) {
      this.returnObject.name = 'custaccount';
      this.returnObject.bankAcctNm = this.$refs.grid.cells(rId, 1).getValue();
      this.returnObject.bankBranchNm = this.$refs.grid.cells(rId, 2).getValue();
