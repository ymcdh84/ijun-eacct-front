...
export default {
  ...
  methods: {
    ...
    onCellClicked(event) {
      ...
      if(field === "roleMenu"){
        this.$modal.open({component: AuthMngMenu, parent: this, width: 800, props: {compCd: sCompCd, roleCd: sRoleCd}})
      }else if(field === "roleUser"){
        this.$modal.open({component: AuthMngUser, parent: this, width: 800, props: {compCd: sCompCd, roleCd: sRoleCd}})
      }
