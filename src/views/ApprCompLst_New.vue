                        ...
                        <div class="search_box_wrap">
                            ...
                            <div class="search_box_pop">
                                ...
                                <div class="search_con search-area">
                                    ...
                                    <input class="input dp-ib input-bg w20p_5r" type="text" v-model="form.draftUserId" disabled>
                                    <input class="input dp-ib input-bg w30p" type="text" v-model="form.draftNm" @input="initEmp" @keypress.enter="popEmp">
